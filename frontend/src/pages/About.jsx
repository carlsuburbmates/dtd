        ...
        <div className="App min-h-screen">
            ...
            <main className="max-w-4xl mx-auto px-6 md:px-10 pt-14 pb-8">
                ...
                <h1 className="editorial-h1 text-5xl sm:text-6xl text-[#1A3A32] mt-3">
                    We are a match engine, not a directory.
                </h1>
                <p className="mt-5 text-lg text-[#4A615A] max-w-3xl leading-relaxed">
                    Bark&amp;Bond helps dog owners describe one real problem and immediately get the most relevant trainer options.
                    Ranking is based on relevance and verified outcomes, not paid placement tiers.
                </p>

                <div className="grid md:grid-cols-2 gap-5 mt-10">
                    <article className="card-public p-6">
                        <h2 className="font-serif text-3xl text-[#1A3A32]">For dog owners</h2>
                        <p className="mt-2 text-[#4A615A]">You get 3 ranked matches and can connect instantly.</p>
                        <Link to="/" data-testid="about-owner-cta" className="btn-primary mt-5 inline-flex">Match now</Link>
                    </article>
                    <article className="card-public p-6">
                        <h2 className="font-serif text-3xl text-[#1A3A32]">For trainers</h2>
                        <p className="mt-2 text-[#4A615A]">You pay for verified demand, not a monthly listing rent.</p>
