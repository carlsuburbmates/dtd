...
![Cover Image](/images/mod_06_cover.jpg)
...
> **Common Mistake:** Thinking the dog needs a longer walk when the dog actually needs an easier walk, and continuing forward because the owner feels embarrassed or committed to the route.
...
> **Rule for this lesson:** A useful walk is one the dog can recover from. If the dog cannot think, sniff, take food, or move normally, make the walk smaller.
