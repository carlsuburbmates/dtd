...
def _education_launch_posture(phase_state: Dict[str, Any]) -> Dict[str, str]:
    ...
    if live_matching or phase == "live_matching":
        return {
            ...
            "summary": "Keep using The First Leash, then bridge into trainer matching only when support is actually needed.",
            "owner_cta_label": "Continue where you left off",
    ...
    if phase == "growth":
        return {
            ...
            "summary": "The First Leash stays primary while DTD expands verified coverage. Owners should keep using the guide and waitlist instead of assuming immediate trainer availability.",
            "owner_cta_label": "Continue where you left off",
            "owner_cta_href": "/education/dashboard",
            "trainer_cta_label": "Return to The First Leash",
    ...
    if phase == "owner_waitlist":
        return {
            ...
            "summary": "Owners can use The First Leash, save their place, and register interest while DTD keeps matching posture conservative.",
            "owner_cta_label": "Continue where you left off",
            "owner_cta_href": "/education/dashboard",
...
async def get_education_dashboard(owner_session: Dict[str, Any] = Depends(require_education_owner)) -> Dict[str, Any]:
    ...
    return {
        ...
        "today_action": today_action,
        "course_overview": {
            "title": str((catalog.get("course") or {}).get("title") or "The First Leash"),
