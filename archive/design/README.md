...
If any design or screen-state decision changes, update the wireframe state map,
the relevant design docs, and the token file in the same session when they are
affected.
